...
void inc_raw_false_matrix(uint64_t address1, uint64_t address2, int a, int b, double inc_false_matrix);

void inc_raw_true_matrix(uint64_t address, int a, int b, double inc_false_matrix);

void inc_raw_false_matrix_by_object_id(int id, int a, int b, double inc_false_matrix);

void inc_raw_true_matrix_by_object_id(int id, int a, int b, double inc_false_matrix);

void inc_waw_false_matrix(uint64_t address1, uint64_t address2, int a, int b, double inc_false_matrix);

void inc_waw_true_matrix(uint64_t address, int a, int b, double inc_false_matrix);

void inc_waw_false_matrix_by_object_id(int id, int a, int b, double inc_false_matrix);

void inc_waw_true_matrix_by_object_id(int id, int a, int b, double inc_false_matrix);
